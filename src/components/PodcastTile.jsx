...
import { genres } from "../data.js"; // Make sure to have a local genre list
...
function PodcastTile({ podcast, onClick }) {
  ...
  return (
    ...
    >
      <img
        src={podcast.image}
        alt={podcast.title}
        className="w-full h-[20vh] object-cover rounded-lg mb-3"
      />
      <div className="pl-2">
